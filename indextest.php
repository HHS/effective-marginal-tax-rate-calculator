...
if( isset($_POST['input']) ) { 
	...
	$titles = array('','Location &amp; Family Size','Household','Current Benefits','Income','Child Care','Health Care','Other Expenses','Results');
	$titles_long = array('', 
...
<?php include("../../inc/headers_page.php"); ?>
    ...
    <?php if ($page == 1): ?>
<p>This tool will show you how your benefits change when your income changes. There are 7 steps with questions for you to answer. Step 8 will show you your results and suggest next steps.</p>
<!--    <p>The Benefit Cliffs Calculator shows what happens to your benefits when your income changes. This is the first step of seven steps the calculator uses to ask what it needs to estimate your current financial situation and how your situation might change after your income changes. The last step, step 8, includes the calculator's estimates and some next steps that you can take, depending on your situation.</p>-->

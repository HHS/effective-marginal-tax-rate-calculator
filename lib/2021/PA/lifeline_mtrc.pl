#=============================================================================#
#  Lifeline (telephone subsidies) Module -- PA 2021
#=============================================================================#
#
...
sub lifeline
{
	...
	our $lifeline_cost = 0; #In Allgheny County PA, several wireless companies is one of at least several companies that offer a free voice, text, and data wireless or landline plan.  See https://www.alleghenycounty.us/WorkArea/linkit.aspx?LinkIdentifier=id&ItemID=6442465519. 
